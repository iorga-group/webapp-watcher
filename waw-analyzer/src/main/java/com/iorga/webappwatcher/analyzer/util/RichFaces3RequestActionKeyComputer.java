...
public class RichFaces3RequestActionKeyComputer extends AbstractRequestActionKeyComputer {
	...
	protected void doComputeEndRequestKey(final StringBuilder requestKeyBuilder, final Map<String, String[]> parameters, final RequestEventLog request) {
		...
		if (parameters.containsKey("AJAX:EVENTS_COUNT")) {
			...
			final String[] ajaxSingle = parameters.get("ajaxSingle");
			if (ajaxSingle != null) {
				// RichFaces 3.x
				requestKeyBuilder.append("?ajaxSingle=").append(ajaxSingle[0]);
			}
		}
	}
